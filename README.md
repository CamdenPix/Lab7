...
**How to find and run the Database:** When SRSDB.bak has been downloaded, go to it's properties, and unblock it. In MS SSMS, restore the database and establish a connection. In Visual Studio (.NET Framework project), connect to the database that was restored in MS SSMS. Be sure to update the configuration files to you MS SSMS server name before building and running this project. We have already created all the models, controllers, and views that are needed to run the web page.
